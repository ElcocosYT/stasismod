...
public class Stasis implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        PARADOX = new StasisChronometer(new Item.Settings()
                .registryKey(PARADOX_KEY)
                .maxCount(1)
                .component(PARADOX_STATE_COMPONENT, ParadoxStateComponent.DEFAULT));
        TEMPORAL_GRIT = new Item(new Item.Settings().registryKey(TEMPORAL_GRIT_KEY));
        STASIS_CORE = new Item(new Item.Settings().registryKey(STASIS_CORE_KEY));
        REINFORCED_DIAMOND = new Item(new Item.Settings().registryKey(REINFORCED_DIAMOND_KEY));
        REINFORCED_NETHERITE = new Item(new Item.Settings().registryKey(REINFORCED_NETHERITE_KEY));
