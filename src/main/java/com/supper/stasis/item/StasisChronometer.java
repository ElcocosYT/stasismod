...
public class StasisChronometer extends Item {
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        return tryActivate(world, user, hand, stack) ? success(world) : ActionResult.FAIL;
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isSneaking()) {
            ...
            return success(context.getWorld());
        }
        return tryActivate(context.getWorld(), player, context.getHand(), stack) ? success(context.getWorld()) : ActionResult.FAIL;
    }
    ...
    public Text getName(ItemStack stack) {
        ParadoxStateComponent state = ParadoxStateHelper.getState(stack);
        return Text.translatable(this.getTranslationKey()).formatted(getNameFormatting(state));
    }
    ...
    private void openScreen(ServerPlayerEntity player, Hand hand) {
        ...
        ParadoxStateComponent state = ParadoxStateHelper.getState(stack);
        int slotIndex = hand == Hand.MAIN_HAND ? player.getInventory().getSelectedSlot() : PlayerInventory.OFF_HAND_SLOT;
    ...
    private ActionResult success(World world) {
